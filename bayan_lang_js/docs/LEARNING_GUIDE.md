...
5. **نظام المعادلات اللغوية (Linguistic Equations System)** ⭐
...
6. **أسس الذكاء الرياضي (Mathematical Intelligence Foundations)** ⭐ **جديد!**
   ...
   - التعلم من صورة واحدة (بدون شبكات عصبية!)
